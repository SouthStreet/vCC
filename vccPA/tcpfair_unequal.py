...
"TCP +- ECN non-ECN has more resoure"
...
from startopo_ue import StarTopoUE
...
parser.add_argument('--bw_host_low', '-Bl',
                    type=float,
                    help="Bandwidth of host links low (Mb/s)",
                    default=100)

parser.add_argument('--bw_host_high', '-Bh',
                    type=float,
                    help="Bandwidth of host links high (Mb/s)",
                    default=100)
...
def tcpfair():
    ...
    topo = StarTopoUE(n=args.hosts, bw_host_high=args.bw_host_high,
                      bw_host_low=args.bw_host_low,
